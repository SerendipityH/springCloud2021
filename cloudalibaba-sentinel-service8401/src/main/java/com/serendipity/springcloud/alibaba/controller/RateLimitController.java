...
import com.serendipity.springcloud.alibaba.hadler.CustomerBlockHandler;
...
public class RateLimitController {
    ...
    {
        return new CommonResult(200,"按url限流测试OK",new Payment(2L,"serial002"));
    }
    ...
    {
        return new CommonResult(200,"按客戶自定义",new Payment(2L,"serial003"));
    }
}
